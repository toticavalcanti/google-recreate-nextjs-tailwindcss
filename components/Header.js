    ...
    <header className="sticky top-0 bg-white">
      <div className="flex w-full p-6 items-center">
        ...
        <Image 
          ...
          onClick={() => ReadableStreamDefaultController.push('/')}
        />
        ...
        border-gray-200 rounded-full shadow-lg max-w-3xl items-center">
          ...
          />
          {/* hidden is to hide in mobile devices(mobile first) */}
          <MicrophoneIcon 
        ...
        <Avatar className="ml-auto" url="https://avatars.githubusercontent.com/u/8420841?s=60&v=4"/>
